...
typedef OnPaidEventCallback = void Function(Ad ad, double valueMicros, PrecisionType precision, String currencyCode);

/// The callback type for when a fluid ad's height changes.
typedef OnFluidAdHeightChangedListener = void Function(FluidAdManagerBannerAd ad, double height);
...
class RewardedInterstitialAdLoadCallback extends FullScreenAdLoadCallback<RewardedInterstitialAd> {
